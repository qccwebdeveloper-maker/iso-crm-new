...
const AUDIT_OBJECTIVES = 'To verify the continued effective implementation, adequacy, conformity and performance of the organization’s Management System during the Surveillance / Re-certification / Special audit. The audit objective is to determine whether the implemented management system continues to meet customer requirements, statutory and regulatory requirements, applicable legal obligations, and the organization’s own policies and objectives. The audit also evaluates process effectiveness, closure of previous nonconformities, risk-based thinking, achievement of objectives, operational controls, monitoring and measurement results, internal audit effectiveness, management review outputs, corrective actions, continual improvement, and use of certification marks.';
